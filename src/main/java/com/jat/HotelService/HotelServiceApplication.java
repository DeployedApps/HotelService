...
@EnableEurekaClient
@OpenAPIDefinition(info = @Info(title = "This Hotel API Microservices. Please Choose another spec from dropdown for other services", version = "3.0", description = "It contains Hotel Information along with ratings & other criteria. API is powered by salient features of Spring Boot e.g. resilence4j, ratelimiters, circuitbreakers" +
