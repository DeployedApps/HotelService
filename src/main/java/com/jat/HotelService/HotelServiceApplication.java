...
@EnableEurekaClient
@OpenAPIDefinition(info = @Info(title = "This is  Hotel Microservices. Please Choose another spec  for other services from dropdown of main Document Server.", version = "3.0", description = "It contains Hotel Information along with ratings & other criteria. API is powered by salient features of Spring Boot e.g. [resilence4j](!https://resilience4j.readme.io/docs),"+ 
